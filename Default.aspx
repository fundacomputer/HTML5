		...
		<div class="main-page-wrapper">
					...
					<nav class="navbar float-right theme-main-menu one-page-menu">
					   ...
					   <div class="collapse navbar-collapse" id="navbar-collapse-1">
					     <ul class="nav navbar-nav">
							...
							<li><a href="#project-section">GALERİ</a></li>
							<li><a href="#team-section">AYIN KİTAPLARI</a></li>
			...
			<section id="about-us">
				<div class="container">
					<div class="theme-title">
						<h1>HAKKIMIZDA</h1>
						<p>Hürkuş Sahaf ve Kitap evi olarak 2018  yılının şuabt ayından itibaren beri   aktif olarak hizmet vermekteyiz.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s"> Güvenilir Hizmet</a></h5>
								<p>Kitaplarımız siparişlerin ardından çok kısa bir sürede,paket için kargoya  verilmektedir.</p>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Hızlı Teslimat</a></h5>
								<p>Saat 150.00'den önce verilen siprişler aynı gün içinde kargoya verilmektedir.</p>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Ücretsiz Kargo</a></h5>
								<p>50 TL ve üzerindeki kitap siparişlerinizde kargo ücreti bize aittir.</p>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Müşteri Memnuniyeti</a></h5>
			...
			<div id="service-section">
				<div class="container">
					<div class="theme-title">
						<h2>HİZMETLERİMİZ</h2>
						<p>7/24 Sipariş ve çok hızlı kargo ile %99 müşpteri memnuyeti sağlandığımız sitemizde satışlarımız devam etmektedir.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">Sıfır Kitaplar</a></h6>
								</div>
								<p>Sevdiklerinize en güzel doğum günü hediyesi kitaptır.Onlara bir kitap alın. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								...
								<p>Saat 15.00'den önce verilen tüm şiparişler kargoya çıkar. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">%99 Müşteri Memnuyeti</a></h6>
								</div>
								<p>Şu ana  kadar yağtığımız 3 binden fazla işlemde %99 memnuniyet oranı yakaladık. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								...
								<p>Bize ulaşın kısmında numaradan sat 08.00-23.00 arası her an ulaşı sağlayabilirsiniz.</p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-service-content">
								<div class="icon-heading tran3s">
									...
									<h6><a href="#" class="tran3s">İstek Kitap</a></h6>
								</div>
								<p>Listenizde olmayan kitapları mesaj atarsanız 3 güne tedarik ederiz. </p>
							</div> <!-- /.single-service-content -->
						</div> <!-- /.col-lg -->
					</div> <!-- /.row -->
				</div> <!-- /.container -->
			...
			<div id="project-section">
				<div class="container">
					<div class="theme-title">
						<h2>GALERİ</h2>
						<p>Sahafımız vitrinden bizim beğendiğimiz bazı kitaplar.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="project-gallery clear-fix">
							...
							<div class="single-img">
								...
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Eşim İsterse Olur </a></h6>
						...
						<div class="mix grid-item web om">
							<div class="single-img">
								...
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Gerçek Mutluluk</a></h6>
										</div>
						...
						<div class="mix grid-item photo webd dmedia om">
							<div class="single-img">
								...
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Kürk Mantolu Madonna</a></h6>
						...
						<div class="mix grid-item photo webd dmedia support">
							<div class="single-img">
								...
								<div class="opacity">
									<div class="border-shape"><div><div>
										<h6><a href="#">Küçük Kara Balık</a></h6>
					...
					<div class="clear-fix team-member-wrapper">
						<div class="float-left">
							<div class="single-team-member">
								<div class="img">
									<img src="images/Kitaplar2/1.jpg" alt="Image">
									<div class="opacity tran4s">
										<h4>Kitap 1</h4>
										<span>İki Şehrin Hikayesi</span>
										<p> Fransız İhtilalinin sürecinde yaşanılanların anlatıldığı bir kitaptır.</p>
									</div>
								</div> <!-- /.img -->
						...
						<div class="float-left">
							<div class="single-team-member">
								<div class="img">
									<img src="images/Kitaplar2/2.jpg" alt="Image">
									<div class="opacity tran4s">
										<h4>Kitap 2</h4>
						...
						<div class="float-left">
							<div class="single-team-member">
								<div class="img">
									<img src="images/Kitaplar2/3.jpg" alt="Image">
									<div class="opacity tran4s">
										<h4>3. Kitap</h4>
				...
				<div class="container">
					<div class="clear-fix">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="img"><img src="images/Kitaplar2/hurkus.jpg" alt="Image"></div>
						</div> <!-- /.col- -->
							        ...
							        <div class="codeconSkills">
							            <div class="codeconSkillbar">
							            	<div class="skill-text">
							            		<span class="codeconSkillArea">Müşteri Memnuyeti</span>
							            	</div>
								        ...
								        <div class="codeconSkillbar">
								        	<div class="skill-text">
							            		<span class="codeconSkillArea">Web Sitesi Zİyareti</span>
